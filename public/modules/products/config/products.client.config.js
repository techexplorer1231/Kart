...
angular.module('products').run(['Menus',
	function(Menus) {
		...
		Menus.addSubMenuItem('topbar', 'products', 'View Kart', 'products/kart');
		Menus.addSubMenuItem('topbar', 'products', 'View Catalogue', 'products/catalogue');
		Menus.addSubMenuItem('topbar', 'products', 'View Checkout', 'products/checkout');
	}
]);